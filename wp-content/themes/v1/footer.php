  	<footer>
      <div class="mini-wrap">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/v1-wordmark-black.png" alt="">
        ...
        <p>The desigin was inspired by <a href="https://brittanychiang.com/">Brittany Chiang</a>'s absolutely killer website.</p>
      </div>
  	</footer>
  <?php wp_footer(); ?>
